...
%             A.pPos.X            
        ...
        if  t_atual < (t_estabilizacao -1)
            xref =  Rwb*(A.pPos.dXd(7:8) + 6/2*(A.pPos.Xd(7:8) - A.pPos.X(7:8)) + 8/2*(A.pPos.Xd(1:2) - A.pPos.X(1:2)) + Int(1:2)); % No noise
            zref = A.pPos.dXd(9) + 2*(A.pPos.Xd(9) - A.pPos.X(9)) + 4*(A.pPos.Xd(3) - A.pPos.X(3) + Int(3));
        else
